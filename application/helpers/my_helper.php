...
if (!function_exists('textInputBuilder')) {
    function textInputBuilder($name, $value, $placeholder=null) {
        $textBox = array(
        				'name' => $name, 
        				'id' => $name,
...
if (!function_exists('ckeditorBuilder')) {
    function ckeditorBuilder($name, $value) {
        $textBox = array('name' => $name, 'class' => 'ckeditor', 'value' => set_value($name, $value));
        return $textBox;
    }
...
if (!function_exists('textAreaBuilder')) {
    ...
    function textAreaBuilder($name, $value, $id=null) {
        $textarea = array(
        					'name' => $name, 
        					'value' => set_value($name, $value), 
        					'class'=>'form-control',

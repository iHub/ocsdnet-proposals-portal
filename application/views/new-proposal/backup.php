                ...
                <div class="row">
                    <div class="col-md-12">
                        <table align="center" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td><!-- Smart Wizard --><h2>Proposal Application form</h2>
                                <div id="wizardmain" class="swMain">
                                    <ul>
                                        <li>
                                            <a href="#step-1"> <label class="stepNumber">1</label> <span class="stepDesc"> Step 1
                                                <br />
                                                <small>General Project Info</small> </span> </a>
                                        </li>
                                        <li>
                                            <a href="#step-2"> <label class="stepNumber">2</label> <span class="stepDesc"> Step 2
                                                <br />
                                                <small>Team & Institution Info</small> </span> </a>
                                        </li>
                                        <li>
                                            <a href="#step-3"> <label class="stepNumber">3</label> <span class="stepDesc"> Step 3
                                                <br />
                                                <small>Proposed Study Info</small> </span> </a>
                                        </li>
                                        <li>
                                            <a href="#step-4"> <label class="stepNumber">4</label> <span class="stepDesc"> Step 4
                                                <br />
                                                <small>Research Administration</small> </span> </a>
                                        </li>
                                        <li>
                                            <a href="#step-5"> <label class="stepNumber">5</label> <span class="stepDesc"> Step 5
                                                <br />
                                                <small>Budget</small> </span> </a>
                                        </li>
                                    </ul>
                                    </div>
                                    <div id="step-1">
                                        ...
                                        <section>
                                            <form role="form" class="project-info" action="<?php echo base_url(); ?>index.php/proposal/projectinfo">
                                                ...
                                                <div class="form-group">
                                                    <label for="projectTitle">Duration of the project</label>
                                                    <br/>
                                                ...
                                                <div class="form-group">
                                                    <label for="projectTitle">Countries included in this project</label>
                                                    <br/>
                                                    ...
                                                    <input type="text" class="form-control" name="countries" id="countries" placeholder="" value="<?php if ($present) { echo $countries_covered;} ?>"/>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="checkbox">
                                                        <label>
                                                            ...
                                                            Theme 1: Motivations (Incentives and Ideologies) </label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <label>
                                                            <input type="checkbox"  name="themes" value="Theme 2: Infrastructures and Technologies">
                                                            Theme 2: Infrastructures and Technologies </label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <label>
                                                            <input type="checkbox"  name="themes" value="">
                                                            Other
                                                            Theme 3: Communities of Practice in Open and Collaborative Science </label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="themes" value="Theme 4: Potential Impacts (Positive and Negative) of Open and Collaborative Science">
                                                            Theme 4: Potential Impacts (Positive and Negative) of Open and Collaborative Science </label>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="projectTitle">Justification of Research Themes</label>
                                                    <br/>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="budget"  class="form-control" id="project-title" placeholder="" value="<?php if ($present) { echo $budget; } ?>"/>
                                            ...
                                            <section>
                                                <form class="researcher-info" action="<?php echo base_url(); ?>index.php/proposal/researchinfo">
                                                    <fieldset>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="pd">IDRC Affiliation (if any)</label>
                                                                <br/>
...
>>>>>>> f3cc24af8050479cca5852d7cf88db69ee0b83b6
                                                ...
                                                <form  class="collaborator-info" action="<?php echo base_url(); ?>index.php/proposal/collaboratorinfo">
                                                    <fieldset>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="pdCoCi">Country of incorporation</label>
                                                                <br/>
                                                                <input type="text" name="countryincorporation" placeholder="" class="form-control"/>
                                                            </div>
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="pdCoc">Country of Citizenship</label>
                                                                <br/>
                                                                <input type="text" name="citizenship" placeholder="" class="form-control"/>
                                                            </div>
                                                            <div class="form-group">
...
<<<<<<< HEAD
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <br/>
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="gender" id="pdMale" value="option1">
                                                                    Male </label>
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="gender" id="pdFemale" value="option2">
                                                                    Female </label>
                                                                <br/>
                                                        ...
                                                        <p>
                                                            Please explain the specific role that this person will play in the proposed project
                                                        </p>
                                                        <br/>
                                                        <textarea name="role" placeholder="" rows="3" class="form-control"></textarea>
                                                        <br/>
                                                        <hr/>
                                                        <a class="btn btn-default ">Add New Collaborator</a>
                                                        <br/>
=======
                                           <button type="submit" class="btn btn-default">Save</button>
                                      </fieldset>
                                            ...
                                            <section>
                                                <form class="institution-info" action="<?php echo base_url(); ?>index.php/proposal/institutioninfo">
                                                    <fieldset>
                                                        ...
                                                        <h3 class="fs-subtitle">Proposing Institution</h3>
                                                        <p>
                                                            The proposing institution receives and manages the project funds provided by the IDRC. Please indicate the contact information of
                                                            the administration office to which funds may be dispensed should this application be accepted.
                                                        </p>
                                                        <div class="col-md-10 no-margin">
                                                            <input type="hidden" id="institution_research_id" name="researcher_id" value="<?php if ($present) { echo $researcher_id; } ?>"/>
                                                            
                                                            <div class="form-group">
                                                                <label for="piION">Institution/ Organization name</label>
                                                                <br/>
                                                                <input type="text" name="name" placeholder="" class="form-control"/>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="piMA">Mailing Address</label>
                                                                <br/>
                                                                <label for="pdiMA">Including office or departmental name</label>
                                                                <br/>
                                                                <textarea name="mailaddress" class="form-control"> </textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="piTN">Telephone Number</label>
                                                                <br/>
                                                                <input type="number" name="phone" placeholder="" class="form-control"/>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="piE">Email</label>
                                                                <br/>
                                                                <input type="text" name="email" placeholder="" class="form-control"/>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="piOE">Office Address</label>
                                                                <br/>
                                                                <textarea name="address" placeholder="" rows="3" class="form-control"></textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="piFoN">Finance Officer’s name</label>
                                                                <br/>
                                                                <label for="piFoN">Name for the main point of contact for financialse</label>
                                                                <br/>
                                                                <input type="text" name="financename" placeholder="" class="form-control"/>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="piFoPN">Finance Officer phone number</label>
                                                                <br/>
                                                                <label for="piFoPN">Phone number for the main point of contact for financials</label>
                                                                <br/>
                                                                <input type="text" name="financephone" placeholder="" class="form-control"/>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="piFoE">Finance Officer Email</label>
                                                                <br/>
                                                                <label for="piFoR">Email address for the main point of contact for financials</label>
                                                                <br/>
                                                                <input type="text" name="financeemail" placeholder="" class="form-control"/>
                                                            </div>
                                                            <button type="submit" class="btn btn-default">
                                            ...
                                            <section>
                                                <form class="institution-supporting-info" action="<?php echo base_url(); ?>index.php/proposal/institutionparticipatinginfo">
                                                    <fieldset>
                                                        ...
                                                        <h3>Participating Institutions</h3>
                                                        <p>
                                                            Participating institutions put forward the research proposal under the leadership of the proposing institution. Note that all funding will
                                                            be disbursed directly to the proposing institution only.
                                                        </p>
                                                        <div class="col-md-10 no-margin">

                                                            <input type="hidden" name="institution_supportresearch_id" value="<?php if ($present){ echo $id; }?>"/>
                                                            <div class="form-group">
                                                                <label for="pi3IN">Institution name</label>
                                                                <br/>
                                                                <input type="text" name="name" placeholder="" class="form-control"/>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="pi3TN">Telephone Number </label>
                                                                <br/>
                                                                <input type="number" name="phone" placeholder="" class="form-control"/>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="pi3E">Email</label>
                                                                <br/>
                                                                <input type="email" name="email" placeholder="" class="form-control"/>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="pi3TN">Address </label>
                                                                <br/>
                                                                <textarea name="address" placeholder="" rows="3" class="form-control"></textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="pi3MA">Mailing Address</label>
                                                                <br/>
                                                                <label for="pi3MA">Including office or departmental name</label>
                                                                <br/>
                                                                <input type="text" name="mailingaddress" placeholder="" class="form-control"/>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="pi3MA">Role in the project</label>
                                                                <br/>
                                                                <textarea name="role" placeholder="" rows="3" class="form-control"></textarea>
                                                                <br/>
                                                                <hr/>
                                                            </div>
                                                            <a class="btn btn-default ">Add New Institution</a>
                                                            <br/>

...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
                                                                                                ...
                                                                                                <div id="step-1">
                                                                                                    ...
                                                                                                    <section>
                                                                                                        <form role="form" class="project-info" action="<?php echo base_url(); ?>index.php/proposal/projectinfo">
                                                                                                            <input type="hidden" name="proposal_id" class="form-control"  value="<?php if ($present) {
    echo $id;
} ?>" />
                                                                                                            <div class="form-group">
                                                                                                                <label for="projectTitle">Project Title</label>
                                                                                                                <input type="text" class="form-control" id="title" name="title" value="<?php if ($present) {
    echo $title;
                                                                                                            ...
                                                                                                            <div class="form-group">
                                                                                                                ...
                                                                                                                <input type="text" class="form-control" name="duration" value="<?php if ($present) {
    echo $duration;
                                                                                                            ...
                                                                                                            <div class="form-group">
                                                                                                                ...
                                                                                                                <input type="text" class="form-control" value="<?php if ($present) {
    echo $countries_covered;
} ?>" name="countries" id="countries" placeholder="">
                                                                                                            </div>
                                                                                                            <div class="form-group">
                                                                                                            ...
                                                                                                            <div class="form-group">
                                                                                                                ...
                                                                                                                <textarea class="form-control ckeditor" name="justifythemes" rows="3"><?php if ($present) {
    echo $justification_of_research_themes;
} ?></textarea>
                                                                                                            </div>
                                                                                                            <div class="form-group">
                                                                                                                <label for="projectTitle">Total Budget Cost (CAD)</label>
                                                                                                                <input type="text" name="budget" value="<?php if ($present) {
    echo $budget;
} ?>" class="form-control" id="project-title" placeholder="">
                                                                                                            </div>
                                                                                                        ...
                                                                                                        <section>
                                                                                                            <form  class="collaborator-info" action="<?php echo base_url(); ?>index.php/proposal/collaboratorinfo">
                                                                                                                <fieldset>
                                                                                                                    ...
                                                                                                                    <div class="col-md-6">
                                                                                                                        <input type="hidden" id="researcher_id" name="researcher_id" value="<?php if ($present) {
    echo $researcher_id;
} ?>"/>
                                                                                                                        <div class="form-group">
                                                                                                                            <label for="pdName">Name</label><br/>
                                                                                                            ...
                                                                                                            <form class="institution-info" action="<?php echo base_url(); ?>index.php/proposal/institutioninfo">
                                                                                                                <fieldset>
                                                                                                                    ...
                                                                                                                    <div class="col-md-10 no-margin">
                                                                                                                        <input type="hidden" id="institution_research_id" name="researcher_id" value="<?php if ($present) {
    echo $researcher_id;
} ?>"/>
                                                                                                                        <div class="form-group">
                                                                                                        ...
                                                                                                        <section>
                                                                                                            <form class="institution-supporting-info" action="<?php echo base_url(); ?>index.php/proposal/institutionparticipatinginfo">
                                                                                                                <fieldset>
                                                                                                                    ...
                                                                                                                    <div class="col-md-10 no-margin">
                                                                                                                        <input type="hidden" id="institution__supportresearch_id" name="researcher_id" value="<?php if ($present) {
    echo $researcher_id;
} ?>"/>
                                                                                                                        <div class="form-group">
                                                                                                ...
                                                                                                <div id="step-3">
                                                                                                    ...
                                                                                                    <section>
                                                                                                        <form role="form" class="proposed-study-info" action="<?php echo base_url(); ?>index.php/proposal/stepthree">
                                                                                                            <input type="hidden" name="proposal_id" value="<?php if ($present) {
    echo $id;
} ?>" />
                                                                                                            <div class="form-group">
                                                                                                                <label for="researcherName">Research Project Abstract </label><br/>
                                                                                                                <p>Should not exceed 250 words</p>
                                                                                                                <textarea name="researchproject"class="form-control ckeditor" rows="3"><?php if ($present) {
    echo $research_project_abstract;
                                                                                                            ...
                                                                                                            <div class="form-group">
                                                                                                                ...
                                                                                                                <textarea name="researchproblem" class="form-control ckeditor" rows="3"><?php if ($present) {
    echo $research_problem_significance_and_justification;
                                                                                                            ...
                                                                                                            <div class="form-group">
                                                                                                                ...
                                                                                                                <p>WORD LIMIT: 500. Outline your project’s central research question(s), subquestions, and objectives. There must be congruency between the questions,
                                                                                                                    ...
                                                                                                                    OCSDNet.</p>
                                                                                                                <textarea name="researchquestions" class="form-control ckeditor" rows="3"><?php if ($present) {
    echo $research_questions_and_objectives;
                                                                                                            ...
                                                                                                            <div class="form-group">
                                                                                                                ...
                                                                                                                <textarea name="analysissynthesis" class="form-control ckeditor" rows="3"><?php if ($present) {
    echo $analysis_and_synthesis;
                                                                                                            ...
                                                                                                            <div class="form-group">
                                                                                                                ...
                                                                                                                <textarea name="outcomesoutputs" class="form-control ckeditor" rows="3"><?php if ($present) {
    echo $outcomes_and_outputs;
                                                                                                            ...
                                                                                                            <div class="form-group">
                                                                                                                ...
                                                                                                                <textarea name="translationdissemination" class="form-control ckeditor" rows="3"><?php if ($present) {
    echo $knowledge_translation_and_dissemination;
                                                                                                            ...
                                                                                                            <div class="form-group">
                                                                                                                ...
                                                                                                                <textarea name="networkconnetions" class="form-control ckeditor" rows="3"><?php if ($present) {
    echo $network_connections_and_interactions;
                                                                                                            ...
                                                                                                            <div class="form-group">
                                                                                                                ...
                                                                                                                <p>APA syle</p>
                                                                                                                <input type="text" name="bibliography" class="form-control" id="bibliography" value="<?php if ($present) {
    echo $bibliography;
} ?>" placeholder="">
                                                                                                            </div>
                                                                                                            <button type="submit" class="btn btn-default">Save</button>
    ...
    echo $id;
                                                                                                            ...
                                                                                                            <div class="form-group">
                                                                                                                ...
                                                                                                                <p>WORD LIMIT: 500. Provide a plan for how you will obtain research ethics approval. All projects that include human subjects must ensure that their privacy,
                                                                                                                    ...
                                                                                                                    maintained.</p>
                                                                                                                <textarea class="form-control ckeditor" name="researchethics" rows="3"><?php if ($present) {
    echo $research_ethics;
                                                                                                            ...
                                                                                                            <div class="form-group">
                                                                                                                ...
                                                                                                                <textarea class="form-control ckeditor" name="internalproject" rows="3"><?php if ($present) {
    echo $internal_project_communication_and_management;
                                                                                                            ...
                                                                                                            <div class="form-group">
                                                                                                                ...
                                                                                                                <textarea class="form-control ckeditor" name="challengesandrisks" rows="3"><?php if ($present) {
    echo $challenges_and_risks;
                                                                                                            ...
                                                                                                            <div class="form-group">
                                                                                                                ...
                                                                                                                <textarea class="form-control ckeditor"name="monitoringevaluation" rows="3"><?php if ($present) {

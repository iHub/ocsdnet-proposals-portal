...
credentials, funded research projects (including those supported by the IDRC), language skills (spoken and written) and relevant publications.</p>
      ...
      credentials, funded research projects (including those supported by the IDRC), language skills (spoken and written) and relevant publications.</p>
                        <a class="btn btn-default ">Download CV Template</a>
                                          ...
                                          <textarea class="form-control" name="role" placeholder="" rows="3"></textarea><br/>
                                          <hr/>
      ...
      be disbursed directly to the proposing institution only.</p>
                              ...
                              <div class="form-group">
                                ...
                                <textarea name="researchproject"class="form-control ckeditor" rows="3"><?php if ($present) {echo $research_project_abstract;}?></textarea>
                              </div>
                              <div class="form-group">
...
and capacity needs of the countries involved.</p>
                                <textarea name="researchproblem" class="form-control ckeditor" rows="3"><?php if ($present) {echo $research_problem_significance_and_justification;}?></textarea>
                              </div>
                              <div class="form-group">
...
OCSDNet.</p>
                                <textarea name="researchquestions" class="form-control ckeditor" rows="3"><?php if ($present) {echo $research_questions_and_objectives;}?></textarea>
                              </div>
                              <div class="form-group">
...
activity will contribute to the study objectives.</p>
                              ...
                              <div class="form-group">
                                ...
                                <textarea name="analysissynthesis" class="form-control ckeditor" rows="3"><?php if ($present) {echo $analysis_and_synthesis;}?></textarea>
                              </div>
                              <div class="form-group">
...
principles of open and collaborative science.</p>
                                <textarea name="outcomesoutputs" class="form-control ckeditor" rows="3"><?php if ($present) {echo $outcomes_and_outputs;}?></textarea>
                              </div>
                              <div class="form-group">
...
relevant stakeholder groups</p>
                                <textarea name="translationdissemination" class="form-control ckeditor" rows="3"><?php if ($present) {echo $knowledge_translation_and_dissemination;}?></textarea>
                              </div>
                              <div class="form-group">
...
approaches discussed at the OCSDNet workshop, if applicable.</p>
                                <textarea name="networkconnetions" class="form-control ckeditor" rows="3"><?php if ($present) {echo $network_connections_and_interactions;}?></textarea>
                              </div>
                              <div class="form-group">
                                <label for="bibliography">Bibliography</label><br/>
                                <p>APA syle</p>
                                <input type="text" name="bibliography" class="form-control" id="bibliography" value="<?php if ($present) {echo $bibliography;}?>" placeholder="">
                              </div>
                              <button type="submit" class="btn btn-default">Save</button>
                            </form>
                        </section>
...
maintained.</p>
                                <textarea class="form-control ckeditor" name="researchethics" rows="3"><?php if ($present) {echo $research_ethics;}?></textarea>
                              </div>
                              <div class="form-group">
...
will be managed and how administrative matters will be addressed.</p>
                                <textarea class="form-control ckeditor" name="internalproject" rows="3"><?php if ($present) {echo $internal_project_communication_and_management;}?></textarea>
                              </div>
                              <div class="form-group">
...
manage these concerns should they arise. Outline the mechanisms that are in place to cope with any unforeseeable complications.</p>
                                <textarea class="form-control ckeditor" name="challengesandrisks" rows="3"><?php if ($present) {echo $challenges_and_risks;}?></textarea>
                              </div>
                              <div class="form-group">
...
data sources that you will use. Your outline should correspond with your project timeline</p>
                                <textarea class="form-control ckeditor"name="monitoringevaluation" rows="3"><?php if ($present) {echo $monitoring_and_evaluation;}?></textarea>
                              </div>
                              <button type="submit" class="btn btn-default">Save</button>
                            </form>
                                            </section>
